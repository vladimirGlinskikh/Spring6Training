...
class BeerControllerTest {
    ...
    BeerServiceImpl beerServicesImpl;
    ...
    void testUpdateBeerBlankName() throws Exception {
        BeerDTO beer = beerServicesImpl.listBeers(null, null).get(0);
        beer.setBeerName("");
    ...
    void testCreateBeerNullBeerName() throws Exception {
        ...
        given(beerService.saveNewBeer(any(BeerDTO.class)))
                .willReturn(beerServicesImpl.listBeers(null, null).get(1));
    ...
    void testListBeers() throws Exception {
        given(beerService.listBeers(null, null)).willReturn(beerServicesImpl.listBeers(null, null));
    ...
    void getBeerById() throws Exception {
        BeerDTO testBeer = beerServicesImpl.listBeers(null, null).get(0);
