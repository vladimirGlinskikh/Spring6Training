...
class BeerControllerTest {
    ...
    void testUpdateBeerBlankName() throws Exception {
        BeerDTO beer = beerServicesImpl.listBeers(null, null, false, 1, 25).getContent().get(0);
        beer.setBeerName("");
    ...
    void testCreateBeerNullBeerName() throws Exception {
        ...
        given(beerService.saveNewBeer(any(BeerDTO.class)))
                .willReturn(beerServicesImpl.listBeers(null, null, false, 1, 25).getContent().get(1));
